...
В дополнении, мы пишем код для людей, поэтому помимо кода, в нём будут комментарии и документация.
...
В `package.json` можно изменить точку входа и добавить скрипты:
